...
def run_query(request:QueryRequest):
    ...
    income_statement_data = get_cached_income_statement_data(
        symbol,
        api_url_root,
        api_key
    )

    "compute other data not in the api responses"

    "create a dataframe out of all data returned"

    "log stuff in MongoDB"
